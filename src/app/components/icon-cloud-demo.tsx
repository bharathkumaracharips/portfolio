...
export default function IconCloudDemo() {
  ...
  return (
    <div className="relative flex w-full max-w-xs items-center justify-center bg-inherit overflow-hidden rounded-lg bg-black/[2.96] antialiased bg-grid-white/[1.02] border border-white">
