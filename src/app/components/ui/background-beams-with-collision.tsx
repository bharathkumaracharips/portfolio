...
export const BackgroundBeamsWithCollision = ({
  ...
  const containerRef = useRef<HTMLDivElement>(null!); // Fixed type assertion
  const parentRef = useRef<HTMLDivElement>(null!); // Fixed type assertion
  ...
  return (
    <>
      <motion.div
        ...
        variants={{
          animate: { translateY: beamOptions.translateY || "1800px", translateX: beamOptions.translateX || "0px", rotate: beamOptions.rotate || 0 },
        }}
        transition={{
