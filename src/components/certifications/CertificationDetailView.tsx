    ...
    <div className="flex flex-col gap-8 p-6 sm:p-10 rounded-2xl bg-[#08080c] border border-white/15 shadow-[0_0_50px_rgba(0,0,0,0.8)] animate-in fade-in zoom-in-95 duration-300">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/10 pb-5">
        ...
        <button
          ...
          className="group flex items-center gap-2 px-4 py-2 rounded-lg bg-white/[0.03] hover:bg-white/[0.08] text-xs font-mono text-zinc-300 hover:text-white border border-white/10 hover:border-white/20 transition-all cursor-pointer"
        >
          <ArrowLeft className="w-3.5 h-3.5 text-[#00F0FF] transition-transform group-hover:-translate-x-1" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-6 flex flex-col justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-white/10">
            ...
            <button
              onClick={onReturnToArchive}
              className="flex items-center gap-2 px-5 py-3 rounded-lg bg-white/[0.03] hover:bg-white/[0.08] text-xs font-mono text-zinc-300 hover:text-white border border-white/10 hover:border-white/20 transition-all"
            >
              <span>RETURN TO ARCHIVE</span>
            </button>
          </div>
